...
var targetEventTypes = ['keydown_active', 'contextmenu_active',
      ...
      case 'touchstart':
        {
          if (!isPressed) {
            ...
            if (!targetIsDocument(_pressTarget)) {
              state.responderRegionOnActivation = calculateResponderRegion(context, _pressTarget, props);
            }
            state.responderRegionOnDeactivation = null;
      ...
      case 'touchmove':
        {
          ...
          if (_pressTarget2 !== null && !targetIsDocument(_pressTarget2) && (pointerType !== 'mouse' || !context.isTargetWithinNode(target, _pressTarget2))) {
      ...
      case 'touchend':
        {
          if (isPressed) {
            ...
            if (_pressTarget3 !== null && props.onPress) {
              if (!isKeyboardEvent && _pressTarget3 !== null && !targetIsDocument(_pressTarget3) && (pointerType !== 'mouse' || !context.isTargetWithinNode(target, _pressTarget3))) {
      ...
      case 'scroll':
        {
          ...
          // trigger a cancel.
          if (_pressTarget4 !== null && (scrollTarget === doc || context.isTargetWithinNode(_pressTarget4, scrollTarget))) {
            dispatchCancel(event, context, props, state);
          }
          break;
        }
