...
function updateEventComponentInstance(eventComponent, props) {
  ...
  if (currentEventComponentInstanceIndex === events.length) {
    dependencies = null;
    var getInitialState = eventComponent.getInitialState;
    void 0 !== getInitialState && (dependencies = getInitialState(props));
    ...
    removeRootEventTypes: function(rootEventTypes) {
      ...
      for (var i = 0; i < rootEventTypes.length; i++) {
        var rootEventType = rootEventTypes[i],
          rootEventComponents = rootEventTypesToEventComponentInstances.get(
            rootEventType
          ),
...
function handleTargetEventResponderInstance(
  ...
  responder = responder.onEvent;
  void 0 !== responder &&
    ((currentInstance = eventComponentInstance),
    (currentlyInHook = isHook),
    responder(responderEvent, eventResponderContext, props, state));
}
...
function registerRootEventType(rootEventType, eventComponentInstance) {
  var rootEventComponentInstances = rootEventTypesToEventComponentInstances.get(
    rootEventType
  );
  void 0 === rootEventComponentInstances &&
...
function dispatchEvent(topLevelType, eventSystemFlags, nativeEvent) {
  if (_enabled) {
    ...
    if (1 === eventSystemFlags) {
      var bookKeeping = targetInst;
      if (callbackBookkeepingPool.length) {
        var instance = callbackBookkeepingPool.pop();
        instance.topLevelType = topLevelType;
        instance.nativeEvent = nativeEvent;
        instance.targetInst = bookKeeping;
        bookKeeping = instance;
      } else
        bookKeeping = {
          topLevelType: topLevelType,
          nativeEvent: nativeEvent,
          targetInst: bookKeeping,
          ancestors: []
        };
      try {
        batchedEventUpdates(handleTopLevel, bookKeeping);
      } finally {
        (bookKeeping.topLevelType = null),
          (bookKeeping.nativeEvent = null),
          (bookKeeping.targetInst = null),
          (bookKeeping.ancestors.length = 0),
          10 > callbackBookkeepingPool.length &&
            callbackBookkeepingPool.push(bookKeeping);
      }
    } else {
      ...
      try {
        ...
        topLevelType = targetFiber;
        for (nativeEvent = nativeEventTarget; null !== topLevelType; ) {
          nativeEventTarget = topLevelType;
          var dependencies = nativeEventTarget.dependencies,
            stateNode = nativeEventTarget.stateNode,
            tag = nativeEventTarget.tag;
          if (5 === tag) nativeEvent = stateNode;
          else if (19 === tag) {
            if (
              ((nativeEventTarget = stateNode),
              null === globalOwner || globalOwner === nativeEventTarget)
            ) {
              var responder = nativeEventTarget.responder,
                responderTarget = instance.get(responder);
              pointerType = !1;
              if (void 0 === responderTarget) {
                var targetEventTypes = responder.targetEventTypes;
                if (void 0 !== targetEventTypes)
                  a: {
                    targetFiber = 0;
                    for (
                      var len = targetEventTypes.length;
                      targetFiber < len;
                      targetFiber++
                    )
                      if (targetEventTypes[targetFiber] === eventSystemFlags) {
                ...
                JSCompiler_temp
                  ? ((responderTarget = nativeEvent),
                    instance.set(responder, nativeEvent))
                  : (pointerType = !0);
              } else
                allowLocalPropagation.has(responder)
                  ? allowLocalPropagation.delete(responder)
                  : (pointerType = !0);
              pointerType ||
                ((bookKeeping.responderTarget = responderTarget),
                (topLevelType = nativeEventTarget.currentFiber),
            ...
            if (null !== _events)
              for (
                nativeEventTarget = 0;
                nativeEventTarget < _events.length;
                nativeEventTarget++
              ) {
                var _eventComponentInstance = _events[nativeEventTarget];
                if (
                  null === globalOwner ||
                  globalOwner === _eventComponentInstance
                ) {
                  var _responder = _eventComponentInstance.responder,
                    _responderTarget = instance.get(_responder);
                  void 0 !== _responderTarget &&
                    ((bookKeeping.responderTarget = _responderTarget),
                    handleTargetEventResponderInstance(
                      bookKeeping,
          ...
          topLevelType = topLevelType.return;
        }
        ...
        if (void 0 !== rootEventInstances) {
          ...
          for (
            allowLocalPropagation = 0;
            allowLocalPropagation < rootEventComponentInstances.length;
            allowLocalPropagation++
          ) {
            var rootEventComponentInstance =
              rootEventComponentInstances[allowLocalPropagation];
            if (
              null === globalOwner ||
              globalOwner === rootEventComponentInstance
            ) {
              var _isHook2 = rootEventComponentInstance.isHook,
                ...
                onRootEvent = _responder2.onRootEvent;
              if (void 0 !== onRootEvent) {
                currentInstance = rootEventComponentInstance;
                currentlyInHook = _isHook2;
                var _responderTarget2 = instance.get(_responder2);
                bookKeeping.responderTarget = _responderTarget2 || null;
                onRootEvent(bookKeeping, eventResponderContext, props, state);
              }
            }
          }
        }
...
function findFirstSuspended(row) {
  for (var node = row; null !== node; ) {
    ...
    } else if (21 === node.tag && void 0 !== node.memoizedProps.revealOrder) {
  ...
  switch (workInProgress.tag) {
        ...
        : ((type = current.memoizedState),
          ...
          newProps ||
            ...
            null !== type &&
              ...
              (type.effectTag = 8))));
      if (newProps && !renderExpirationTime && 0 !== (workInProgress.mode & 2))
        if (
          (null === current &&
    ...
    case 18:
      ...
      if (null === current) {
        ...
        markSpawnedWork(1);
        workInProgress = workInProgress.stateNode;
        if (!workInProgress) throw ReactErrorProd(Error(317));
        a: {
    ...
    case 19:
      ...
      null === props
        ? ((props = null),
          ...
          void 0 !== current && (props = current(newProps)),
          (workInProgress.stateNode = createEventComponentInstance(
            workInProgress,
            newProps,
            type,
            renderExpirationTime,
          ...
          markUpdate(workInProgress))
        : ((props.props = newProps), (props.currentFiber = workInProgress));
      break;
    default:
...
function commitRootImpl(root$jscomp$0) {
  flushPassiveEffects();
  if ((executionContext & (RenderContext | CommitContext)) !== NoContext)
    throw ReactErrorProd(Error(327));
  ...
  root$jscomp$0.firstPendingTime = firstPendingTimeBeforeCommit;
  firstPendingTimeBeforeCommit < root$jscomp$0.lastPendingTime &&
    (root$jscomp$0.lastPendingTime = firstPendingTimeBeforeCommit);
  root$jscomp$0 === workInProgressRoot &&
  ...
  if (null !== firstEffect) {
            ...
            switch (finishedWork$jscomp$0.tag) {
              ...
              case 1:
                if (
                  ...
                  var instance = finishedWork$jscomp$0.stateNode,
        ...
        for (; null !== nextEffect; ) {
          ...
          switch (effectTag & 14) {
            ...
            case 4:
              ...
              break;
            case 8:
              var current$$1$jscomp$1 = nextEffect;
              unmountHostComponents(current$$1$jscomp$1);
              var current$$1$jscomp$2 = current$$1$jscomp$1;
              current$$1$jscomp$2.return = null;
              current$$1$jscomp$2.child = null;
              current$$1$jscomp$2.memoizedState = null;
              current$$1$jscomp$2.updateQueue = null;
              current$$1$jscomp$2.dependencies = null;
              var alternate = current$$1$jscomp$2.alternate;
              null !== alternate &&
      ...
      if (
        ...
        if ("selectionStart" in priorFocusedElem)
          ...
          if (win$jscomp$0.getSelection) {
            ...
            if (!selection$jscomp$1.extend && start$jscomp$1 > end$jscomp$1) {
            ...
            if (
              ...
              start$jscomp$1 > end$jscomp$1
                ? (selection$jscomp$1.addRange(range),
                  selection$jscomp$1.extend(endMarker.node, endMarker.offset))
    ...
    do
      try {
        for (
          var root = root$jscomp$0, committedExpirationTime = expirationTime;
          null !== nextEffect;
          ...
          if (effectTag$jscomp$0 & 36) {
            ...
            var finishedRoot = root,
              current$$1$jscomp$3 = nextEffect.alternate,
              finishedWork$jscomp$1 = nextEffect,
              committedExpirationTime$jscomp$0 = committedExpirationTime;
            switch (finishedWork$jscomp$1.tag) {
              ...
              case 15:
                commitHookEffectList(
                  UnmountLayout,
                  MountLayout,
                  finishedWork$jscomp$1
                );
                break;
              case 1:
                var instance$jscomp$0 = finishedWork$jscomp$1.stateNode;
                if (finishedWork$jscomp$1.effectTag & 4) {
                  if (null === current$$1$jscomp$3)
                    startPhaseTimer(finishedWork$jscomp$1, "componentDidMount"),
                      instance$jscomp$0.componentDidMount();
                  else {
                    var prevProps$jscomp$0 =
                        finishedWork$jscomp$1.elementType ===
                        finishedWork$jscomp$1.type
                          ? current$$1$jscomp$3.memoizedProps
                          : resolveDefaultProps(
                              finishedWork$jscomp$1.type,
                              current$$1$jscomp$3.memoizedProps
                            ),
                      prevState$jscomp$0 = current$$1$jscomp$3.memoizedState;
                    startPhaseTimer(
                      finishedWork$jscomp$1,
                      "componentDidUpdate"
                    );
                ...
                var updateQueue = finishedWork$jscomp$1.updateQueue;
                null !== updateQueue &&
                  commitUpdateQueue(
                    finishedWork$jscomp$1,
                    updateQueue,
                ...
                break;
              case 3:
                var _updateQueue = finishedWork$jscomp$1.updateQueue;
                if (null !== _updateQueue) {
                  var _instance = null;
                  if (null !== finishedWork$jscomp$1.child)
                    switch (finishedWork$jscomp$1.child.tag) {
                      case 5:
                        _instance = finishedWork$jscomp$1.child.stateNode;
                        break;
                      case 1:
                        _instance = finishedWork$jscomp$1.child.stateNode;
                    }
                ...
                break;
              case 5:
                var _instance2 = finishedWork$jscomp$1.stateNode;
                if (
                  null === current$$1$jscomp$3 &&
                  finishedWork$jscomp$1.effectTag & 4
                ) {
                  var domElement = _instance2;
              ...
              case 4:
                break;
              case 12:
                var onRender = finishedWork$jscomp$1.memoizedProps.onRender;
                onRender(
                  finishedWork$jscomp$1.memoizedProps.id,
                  null === current$$1$jscomp$3 ? "mount" : "update",
                  finishedWork$jscomp$1.actualDuration,
                  finishedWork$jscomp$1.treeBaseDuration,
                  finishedWork$jscomp$1.actualStartTime,
                  commitTime,
              ...
              case 17:
                break;
              case 19:
                var eventComponentInstance = finishedWork$jscomp$1.stateNode,
                  doc$jscomp$0 =
                    eventComponentInstance.rootInstance.ownerDocument,
                  documentBody = doc$jscomp$0.body || doc$jscomp$0,
                ...
                if (void 0 !== rootEventTypes) {
                  for (
                    var i$jscomp$0 = 0;
                    i$jscomp$0 < rootEventTypes.length;
                    i$jscomp$0++
                  )
                    registerRootEventType(
                      rootEventTypes[i$jscomp$0],
                      eventComponentInstance
                    );
                  listenToEventResponderEventTypes(
                    rootEventTypes,
  ...
  var remainingExpirationTime = root$jscomp$0.firstPendingTime;
  if (0 !== remainingExpirationTime) {
    ...
    if (null !== spawnedWorkDuringRender) {
      ...
      for (
        var i$jscomp$1 = 0;
        i$jscomp$1 < expirationTimes.length;
        i$jscomp$1++
      )
        scheduleInteractions(
          root$jscomp$0,
          expirationTimes[i$jscomp$1],
  ...
  1073741823 === remainingExpirationTime
