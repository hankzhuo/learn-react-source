...
var revertPassiveEffectsChange = require("ReactFeatureFlags")
...
function updateEventComponentInstance(eventComponent, props) {
  ...
  if (null === dependencies) {
    var events = [];
    currentlyRenderingFiber$2.dependencies = {
      expirationTime: 0,
      firstContext: null,
      events: events
    };
  ...
  if (currentEventComponentInstanceIndex === events.length) {
    ...
    (events = events[currentEventComponentInstanceIndex++]),
      ...
      (events.props = props),
      (events.currentFiber = currentlyRenderingFiber$2);
}
...
function updateDehydratedSuspenseComponent(
  ...
  if (null === current$$1)
    return (
      shim$1(suspenseInstance)
        ? ((current$$1 = requestCurrentTime()),
          (workInProgress.expirationTime =
            1073741821 -
            25 * ((((1073741821 - current$$1 + 500) / 25) | 0) + 1)))
  ...
  if (shim$1(suspenseInstance))
    return (
      ...
      shim$1(suspenseInstance, retryTimedOutBoundary.bind(null, current$$1)),
      null
    );
    ...
    if (5 === node.tag || 6 === node.tag) {
      ...
      if (parentFiber)
        if (isContainer) {
          ...
          if (stateNode === beforeChild) throw ReactErrorProd(Error(218));
      ...
      a: {
        ...
        switch (current$$1.tag) {
            ...
            if (null !== current && null != current$$1.stateNode)
              ...
              switch (current) {
                case TYPES.CLIPPING_RECTANGLE:
                  newProps = Mode.ClippingRectangle();
                  newProps._applyProps = applyClippingRectangleProps;
                  break;
                case TYPES.GROUP:
                  newProps = Mode.Group();
                  newProps._applyProps = applyGroupProps;
                  break;
                case TYPES.SHAPE:
                  newProps = Mode.Shape();
                  newProps._applyProps = applyShapeProps;
                  break;
                case TYPES.TEXT:
                  (newProps = Mode.Text(
                    renderExpirationTime$jscomp$0.children,
                    renderExpirationTime$jscomp$0.font,
                    renderExpirationTime$jscomp$0.alignment,
                    renderExpirationTime$jscomp$0.path
                  )),
                    (newProps._applyProps = applyTextProps);
              }
              if (!newProps) throw ReactErrorProd(Error(217), current);
              newProps._applyProps(newProps, renderExpirationTime$jscomp$0);
              current = newProps;
          ...
          case 19:
            ...
            renderExpirationTime$jscomp$0 = current$$1.type.responder;
            type = current$$1.stateNode;
            if (null === type)
              (type = null),
                (first = renderExpirationTime$jscomp$0.getInitialState),
                void 0 !== first && (type = first(newProps)),
              ...
              throw ((type.props = newProps),
              (type.currentFiber = current$$1),
...
var slice = Array.prototype.slice,
  ...
  Surface = (function(_React$Component) {
    ...
    Surface.prototype.componentDidMount = function() {
      ...
      _props = new FiberRootNode(this._surface, 0, !1);
