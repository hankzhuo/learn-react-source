...
function updateEventComponentInstance(eventComponent, props) {
  ...
  if (currentEventComponentInstanceIndex === events.length) {
    ...
    events.push({
      currentFiber: currentlyRenderingFiber$2,
      isHook: !0,
      props: props,
      responder: eventComponent,
      rootEventTypes: null,
      rootInstance: null,
      state: dependencies || {}
    });
        ...
        switch (current$$1.tag) {
          ...
          case 5:
            ...
            if (null !== current && null != current$$1.stateNode)
              ...
              instanceProps.set(tag, instance);
                    ...
                    if (null !== instance) {
                      ...
                      for (current = current$$1.child; null !== current; )
                        (renderExpirationTime$jscomp$0 = current),
                          ...
                          (instance = renderExpirationTime$jscomp$0.alternate),
                          null === instance
      ...
      if (1 === renderExpirationTime || 1 !== newProps.childExpirationTime) {
        ...
        for (
          ...
          (type = renderExpirationTime$jscomp$0.expirationTime),
            (instance = renderExpirationTime$jscomp$0.childExpirationTime),
